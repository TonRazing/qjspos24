...
<svg width="25" viewbox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">QJS POS</span>
    </a>
      ...
      <div class="d-flex align-items-start row">
        ...
        <div class="col-sm-5 text-center text-sm-left">
          <div class="card-body pb-0 px-0 px-md-6">
            <img :src=" url + '/assets/img/illustrations/man-with-laptop.png'" height="175" class="scaleX-n1-rtl" alt="View Badge User">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body pt-4">
        <ul class="p-0 m-0">
          ...
          <li class="d-flex align-items-center mb-6">
            <div class="avatar flex-shrink-0 me-3">
              <img :src=" url + '/assets/img/icons/unicons/cc-primary.png'" alt="User" class="rounded">
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
